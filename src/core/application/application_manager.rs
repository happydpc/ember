    ...
    pub fn run(mut self) {
        ...
        event_loop.run(move |event, _, control_flow| {
            ...
            match &self.render_manager {
                Some(manager) => {
                    ...
                    match event {
                        ...
                        Event::RedrawEventsCleared => {
                                    _previous_frame_end.as_mut().unwrap().cleanup_finished();
                ...
                }, // end of some arm of manager (meaning it existed).
                // This is the none case for the render manager. This happens if there is no
                // render manager
                None => log::error!("Render manager doesn't exist at time of draw."),
            } // end of entire render manager match
